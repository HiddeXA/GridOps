...
<template>
    ...
    <div
        class="h-screen flex bg-[url(images/Background1.png)] bg-cover bg-center"
    >
        <div
            class="h-screen w-screen absolute bg-black opacity-75"
        ></div>
        <div
            class="z-10 text-white border-2 border-blue-400 rounded w-2/3 md:w-1/3 h-fit m-auto p-4 bg-gray-900 flex flex-col"
        >
            <h2
            ...
            <p
                class="text-center"
            >GridOps is de applicatie om al jouw trackdays te overzien</p>
            <div
                class="inline-flex m-auto"
            >
                <Link
                    :href="login()"
                    class="inline-block mt-2 mx-1 px-2 py-1 text-xl border border-blue-400 rounded hover:bg-blue-400"
                >
                    Log in
                </Link>
                <Link
